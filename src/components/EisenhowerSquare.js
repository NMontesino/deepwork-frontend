...
class EisenhowerSquare extends Component
{
    ...
    render()
    {
        ...
        return(
            ...
            <div className="rounded-lg shadow p-4" style={{'height': '100%', 'width': 'calc((100% - 48px)/2)', 'margin-left': '16px', 'background-color': this.props.colors.bg, 'color': this.props.colors.text}}>
