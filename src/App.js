...
class App extends Component
{
  ...
  autoLogin = () =>
  {
    ...
    if(token)
    {
      fetch('https://deepwork-backend.herokuapp.com/users/auto_login', 
      {
        method: "GET",
        headers: 
        {
  ...
  getReturningUser = (username, password) =>
  {
    ...
    fetch('https://deepwork-backend.herokuapp.com/users/login',
    {
      method: "POST",
      headers:
      {
  ...
  getNewUser = (username, password) =>
  {
    ...
    fetch('https://deepwork-backend.herokuapp.com/users', 
    {
      method: "POST",
      headers: 
      {
